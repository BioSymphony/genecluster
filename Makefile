...
py-compile:
	find skills/biosymphony/scripts skills/biosymphony/remote pipeline tools -name '*.py' -print0 | PYTHONPYCACHEPREFIX="$${TMPDIR:-/tmp}/biosymphony-genecluster-public-pycache" xargs -0 python3 -m py_compile
