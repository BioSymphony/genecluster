...
**License note:** AGPL-3.0+. private use is fine; hosting a public plantiSMASH service downstream would trigger source-publication requirement. **Validated companion**: DeepBGC (validated) as the LSTM-neural-network alternative, no taxon restriction.
