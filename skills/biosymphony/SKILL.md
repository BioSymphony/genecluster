...
| **Novelty** | existing publications mapping pathway-to-species; defensible novelty windows | catalog `key_publication_pmid` + literature-audit agent (3-Opus pattern) |
